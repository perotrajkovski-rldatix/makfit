...
You must be at least 16 years old, or the age required by the laws of your jurisdiction, to use the Service.

## 3. Account and Security

You are responsible for:
- Providing accurate registration/profile information
...
- Progress photos
- Challenges, streaks, points, badges, levels
- Premium features and theme unlocks

We may add, remove, or modify features over time.
...
Displayed pricing and plan details at checkout control your purchase.

### 6.2 Trial Terms
If you start a trial, premium access is enabled for the trial window shown in-app. After trial expiry, billing and status transitions follow the active plan and in-app metadata.

### 6.3 Auto-Renewal
Unless canceled, subscription plans may renew automatically according to your selected plan cycle and checkout terms.

### 6.4 Cancellation
Cancellation methods depend on purchase channel:
- App Store or Google Play: manage via store subscription settings
- Direct web billing provider: manage via that provider portal/account
...
- Attempt unauthorized access or abuse security controls
- Interfere with service reliability or other users
- Upload malware or harmful code
- Use the Service for fraud, harassment, or abuse
...
- Needed to protect users, platform integrity, or rights

You may request account deletion using in-app deletion functionality.
...
These Terms are governed by the laws of the Republic of North Macedonia, excluding conflict-of-law principles.

Disputes will be subject to the exclusive jurisdiction of the competent courts in North Macedonia, unless mandatory law in your jurisdiction provides otherwise.

## 17. Changes to Terms

We may update these Terms from time to time. The Last Updated date will be revised when changes are posted. Continued use after changes become effective means you accept the updated Terms.
